...
int main(int argc, char const *argv[])
{
	...
	glDepthFunc(GL_NOTEQUAL); // depth-testing interprets a smaller value as "closer"
  ...
  // Set up geometry, VBO, EBO, VAO
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(glGetUniformLocation(shader_program, mat), 1, GL_FALSE, glm::value_ptr(modelViewProjectionMatrix));
